...
class StoreTaskRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'recurrence.end_date' => ['nullable', 'date', 'after_or_equal:due_date'],
    ...
    public function messages(): array
    {
        return [
            ...
            'recurrence.frequency.in' => 'Recurrence must be daily, weekly, monthly or yearly.',
        ];
    }

    protected function passedValidation(): void
    {
        // Flatten recurrence config into task columns
        ...
        // Ensure completed status sets completed_at

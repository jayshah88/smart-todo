  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 dark:bg-slate-950">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-1 text-center text-sm text-slate-500 dark:text-slate-400">Start organizing your day</p>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4" noValidate>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full rounded-lg bg-indigo-600 py-2.5 text-sm font-semibold text-white transition hover:bg-indigo-500 disabled:opacity-60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500"
          >
